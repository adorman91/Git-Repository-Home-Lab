...
Add-PrinterDriver -Name "Brother HL-L2460DW Printer" -InfPath "C:\Windows\System32\DriverStore\FileRepository\brohl22a.inf_amd64_3aa7b3980f60ed76\BROHL22A.INF"
Add-PrinterPort -Name "HomeLab Port" -PrinterHostAddress 192.168.0.9
Add-Printer -DriverName "Brother HL-L2460DW Printer" -Name "Brother HL-L2460DW" -PortName "Homelab Port"
